...
- [ ] `site-manifest.json` and `version.json` use the synchronized V7 contract
...
- [ ] Links, forms, hours, click-to-call, address/privacy choice, estimate/scheduling actions, services, and service-area language were checked

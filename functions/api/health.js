export async function onRequestGet(context) {
  ...
  const turnstilePolicyValid = String(env.REQUIRE_TURNSTILE || "true").toLowerCase() === "true";
  ...
  return Response.json({
    status: "ok",
    service: "plumber-website-form",
    provider,
    formDeliveryConfigured: emailConfigured || webhookConfigured,
    turnstileRequired,
    turnstileConfigured: turnstilePolicyValid && turnstileSecretConfigured && turnstileHostnameConfigured && turnstileActionConfigured,
